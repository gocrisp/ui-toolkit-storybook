import{n as e,t,vt as n,yt as r}from"./button-Cs51ASoK.js";import{A as i,B as a,D as o,F as s,N as c,O as l,V as u,k as d}from"./DockNav-EESRezCx.js";import{b as f,n as p}from"./iframe-6Kmxc6tR.js";import{n as m}from"./rolldown-runtime-C0FnF6B9.js";function h(){return(0,g.useContext)(_)}var g,_;function v(){return(v=m((()=>{g=f(),_=(0,g.createContext)(!1)})))()}var y,b,x,S,C,w,T,E,D,O,k,A;function j(){return(j=m((()=>{y=`_banner_5fc4m_12`,b=`_left_5fc4m_51`,x=`_icon_5fc4m_59`,S=`_copy_5fc4m_65`,C=`_label_5fc4m_73`,w=`_target_5fc4m_83`,T=`_actor_5fc4m_90`,E=`_modeBadge_5fc4m_95`,D=`_right_5fc4m_107`,O=`_stopShortcutKey_5fc4m_116`,k=`_stopButton_5fc4m_127`,A={banner:y,left:b,icon:x,copy:S,label:C,target:w,actor:T,modeBadge:E,right:D,stopShortcutKey:O,stopButton:k}})))()}function M(){return(0,F.jsxs)(`svg`,{viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,strokeWidth:`2`,strokeLinecap:`round`,strokeLinejoin:`round`,className:A.icon,"aria-hidden":`true`,children:[(0,F.jsx)(`path`,{d:`M18 11c-1.5 0-2.5.5-3 2`}),(0,F.jsx)(`path`,{d:`M4 6a2 2 0 0 0-2 2v4a5 5 0 0 0 5 5 8 8 0 0 1 5 2 8 8 0 0 1 5-2 5 5 0 0 0 5-5V8a2 2 0 0 0-2-2h-3a8 8 0 0 0-5 2 8 8 0 0 0-5-2z`}),(0,F.jsx)(`path`,{d:`M6 11c1.5 0 2.5.5 3 2`})]})}function N({onStop:e,decorateDocumentTitle:n=!0,reloadOnSessionEnd:r=!0}={}){let i=l(),o=h();(0,P.useRef)(!1),(0,P.useEffect)(()=>{},[o,i]);let c=(0,P.useRef)(null);(0,P.useEffect)(()=>{if(!n||typeof document>`u`||!i)return;c.current===null&&(c.current=document.title);let e=`[Acting as ${i.target.email}] `;return document.title.startsWith(e)||(document.title=e+(c.current??``)),()=>{c.current!==null&&(document.title=c.current,c.current=null)}},[i,n]);let u=(0,P.useRef)(null);(0,P.useEffect)(()=>{let e=u.current;if(u.current=i,e===null||i!==null||!r||typeof window>`u`)return;let t=window.location?.reload;typeof t==`function`&&t.call(window.location)},[i,r]);function f(){i&&(d(),e?.(i))}let{displayKeys:p,ariaKeyShortcuts:m}=s({keys:I,action:()=>f(),description:`Stop impersonating`,group:`Navigation`,enabled:!!i});if(!i)return null;let g=i.target.name?`${i.target.name} (${i.target.email})`:i.target.email;return(0,F.jsxs)(`div`,{className:A.banner,"data-standalone":o?void 0:`true`,role:`status`,"aria-live":`polite`,children:[(0,F.jsxs)(`div`,{className:A.left,children:[(0,F.jsx)(M,{}),(0,F.jsxs)(`div`,{className:A.copy,children:[(0,F.jsx)(`span`,{className:A.label,children:`Impersonating`}),(0,F.jsx)(`span`,{className:A.target,children:g}),(0,F.jsxs)(`span`,{className:A.actor,children:[`as `,i.actor.email]})]}),i.mode===`readonly`&&(0,F.jsx)(`span`,{className:A.modeBadge,"aria-label":`Read-only session`,children:`Read-only`})]}),(0,F.jsx)(`div`,{className:A.right,children:(0,F.jsxs)(t,{type:`button`,size:`xs`,className:A.stopButton,onClick:f,"aria-label":`Stop impersonating ${i.target.email}`,"aria-keyshortcuts":m,children:[(0,F.jsx)(a,{keys:p,kbdClassName:A.stopShortcutKey}),`Stop impersonating`]})})]})}var P,F,I;function L(){return(L=m((()=>{e(),P=f(),v(),u(),c(),i(),o(),j(),F=p(),I=`mod+i`,N.__docgenInfo={description:`Amber banner shown across every authenticated surface while an
...
Requires a surrounding \`KeyboardShortcutProvider\` (installed by the
federated \`mount\` / \`AppStateDockNavShell\`, or manually in Storybook
and non-federated trees) so the stop shortcut registers in the shared
help dialog.
