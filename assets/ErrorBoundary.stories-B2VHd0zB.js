...
screen is not a dead end.`},label:{required:!1,tsType:{name:`string`},description:"Prefixes the `console.error` this boundary always emits."}}}})))()}function h({message:e}){throw Error(e)}var g,_,v,y,b,x,S,C,w;function T(){return(T=s((()=>{m(),g=t(),{userEvent:_,within:v}=__STORYBOOK_MODULE_TEST__,y={minHeight:`100vh`,display:`grid`,placeItems:`stretch`},b={title:`Common/App State`,component:p,parameters:{layout:`fullscreen`},decorators:[e=>(0,g.jsx)(`div`,{style:y,children:(0,g.jsx)(e,{})})]},x={args:{label:`Shell:orders`,children:(0,g.jsx)(h,{message:`Cannot read properties of undefined (reading 'accountId')`})}},S={args:{label:`Shell:orders`,children:(0,g.jsx)(h,{message:`No auth configuration found`})},play:async({canvasElement:e})=>{let t=v(e);await _.click(t.getByRole(`button`,{name:/details/i}))}},C={args:{fallback:({error:e,reset:t})=>(0,g.jsxs)(`div`,{style:{padding:`2rem`},children:[(0,g.jsxs)(`p`,{children:[`This module is unavailable: `,e.message]}),(0,g.jsx)(`button`,{type:`button`,onClick:t,children:`Retry`})]}),children:(0,g.jsx)(h,{message:`chunk load failed`})}},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
    label: 'Shell:orders',
...
}`,...C.parameters?.docs?.source}}},w=[`ErrorBoundaryFallback`,`ErrorBoundaryFallbackDetailsExpanded`,`ErrorBoundaryCustomFallback`]})))()}T();export{C as ErrorBoundaryCustomFallback,x as ErrorBoundaryFallback,S as ErrorBoundaryFallbackDetailsExpanded,w as __namedExportsOrder,b as default};